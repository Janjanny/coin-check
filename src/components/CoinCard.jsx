  ...
  return (
    <>
      <div className="fixed top-0 left-0 w-screen h-screen z-50">
        ...
        <div className=' relative z-[50] text-white top-[50%] left-[50%] p-[1.5rem] rounded w-[30rem]' style={{transform:'translate(-50%, -50%)', background: 'linear-gradient(121deg, rgba(51,51,51,1) 0%, rgba(65,65,65,1) 100%)'}}>
          <div className="row-1 text-sm flex gap-[8px] items-center">
            <div className="div-1 flex items-center gap-[5px]">
              ...
              <p className="coin-name font-bold">Bitcoin</p>
            </div>
            <div className="div-2 flex items-center">
          ...
          <div className="row-2 flex items-center gap-[12px]">
            <h1 className="price text-[2.5rem] font-bold"><span className='currency'>$</span>000,000</h1>
